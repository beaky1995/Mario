...
namespace Spaghetti
{
    public class MarioRightFireCrouchingState : IMarioState
    {
        public ISprite MarioSprite { get; set; }
        private Mario myMario;

        public MarioRightFireCrouchingState(Mario mario)
        {
            myMario = mario;
            MarioSprite = MarioSpriteFactory.Instance.CreateMarioRightFireCrouchingSprite();
        }

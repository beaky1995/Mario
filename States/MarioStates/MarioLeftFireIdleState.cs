...
namespace Spaghetti
{
    public class MarioLeftFireIdleState : IMarioState
    {
        public ISprite MarioSprite { get; set; }
        private Mario myMario;

        public MarioLeftFireIdleState(Mario mario)
        {
            myMario = mario;
            MarioSprite = MarioSpriteFactory.Instance.CreateMarioLeftFireIdleSprite();
        }

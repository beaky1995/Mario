...
namespace Spaghetti
{
    public class LavaBlock : IBlock
    {
        private ISprite lavaTopSprite;
        ...
        {
            lavaBlockSprite.Draw(spriteBatch, camera.AdjustPosition(position));
        }
